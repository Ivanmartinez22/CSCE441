...
public:
	...
	Shape* Hit(Ray ray, float t0, float t1, vector<Shape*> shapes, int &num_triangles);

	//int recursiveBHV_Intersection(Ray ray, BVH* Node);
	Shape * recursiveBHV_Intersection(Ray ray, BVH* Node, float t0, float t1);
